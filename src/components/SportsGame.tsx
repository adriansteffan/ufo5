...
interface SportsGameProps extends BaseComponentProps {
  timelimit?: number;
}

export const SportsGame = ({ next, timelimit }: SportsGameProps) => {
  return (
    <div className='min-h-screen w-full bg-white bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]'>
      <div className='flex flex-col items-center justify-center min-h-screen p-8'>
        <div className='bg-white p-8 rounded-lg max-w-md text-center'>
          <h2 className='text-3xl font-bold mb-4'>FootballSim </h2>
